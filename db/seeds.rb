...
event_team6 = EventTeam.create!(event: match6, team: team4)
...
LeCascabel = Place.create!(characteristic: "Une belle cascade de joie vous y attend", address: "1 Rue Kervégan", city: "Nantes", name:"Le Cascabel", status:"Complet")
...
Giggs = Place.create!(characteristic: "Un match ne se joue pas que sur la pelouse", address: "4 Place Saint-Pierre", city: "Nantes", name:"Gigg's", status:"Places disponibles")
...
macbyrne = Place.create!(characteristic: "Il n'y a pas qu'en irlande qu'on sait savourer un moment de partage autour d'une pinte", address: "21 Rue des Petites Écuries", city: "Nantes", name:"John McByrne", status:"Quelques places")
...
berlin = Place.create!(characteristic: "Lieu de rencontre et de partage reconnu Quoi vous ne connaissez pas ? On vous attend pour vous montrer",  address: "95 Boulevard Gabriel Lauriol", city: "Nantes", name:"Berlin 1989", status:"Places disponibles")
...
lab = Place.create!(characteristic: "En navibus, voiture, vélo, à pieds ou à cheval, tous les chemin mène au LAB", address: "23 Boulevard de Chantenay", city: "Nantes", name:"Little Atlantique Brewery", status:"Complet")
...
bureau = Place.create!(characteristic: "Quoi de mieux que de se retrouver au bureau après une journée de travail ?", address: "10 Quai François Mitterrand", city: "Nantes", name:"Au Bureau", status:"Quelques places")
...
Chatroom.create(name: "La Scierie", place: LaScierie)
Chatroom.create(name: "3 Brasseurs", place: Brasseurs)
Chatroom.create(name: "Le Cascabel", place: LeCascabel)
Chatroom.create(name: "La Belle Equipe", place: LaBelleEquipe)
Chatroom.create(name: "Giggs", place: Giggs)
Chatroom.create(name: "Brady's", place: brady)
Chatroom.create(name: "MacByrne", place: macbyrne)
Chatroom.create(name: "Berlin 1989", place: berlin)
Chatroom.create(name: "Le lab", place: lab)
Chatroom.create(name: "Au Bureau", place: bureau)
