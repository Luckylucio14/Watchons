...
Brasseurs = Place.create!(characteristic: "", address: "Centre Commercial Carré 19 Parvis Neptune 44000 Nantes", name:"3 Brasseurs", status:"Places disponibles")
...
LeCascabel = Place.create!(characteristic: "", address: "1 Rue Kervégan 44000 Nantes", name:"Le Cascabel", status:"Places disponibles")
...
LaBelleEquipe = Place.create!(characteristic: "",  address: "10 Quai de la Jonelière 44000 Nantes", name:"La belle equipe", status:"Places disponibles")
...
Giggs = Place.create!(characteristic: "", address: "4 Pl. Saint-Pierre 44000 Nantes", name:"Gigg's", status:"Places disponibles")
...
brady = Place.create!(characteristic: "", address: "22 Allée Commandant Charcot, 44000 Nantes", name:"Brady's", status:"places disponibles")
...
macbyrne = Place.create!(characteristic: "", address: "21 Rue des Petites Écuries, 44000 Nantes", name:"John McByrne", status:"places disponibles")
...
berlin = Place.create!(characteristic: "",  address: "95 Boulevard Gabriel Lauriol, 44300 Nantes", name:"Berlin 1989", status:"places disponibles")
...
lab = Place.create!(characteristic: "", address: "23 Bd de Chantenay, 44100 Nantes", name:"Little Atlantique Brewery", status:"places disponibles")
