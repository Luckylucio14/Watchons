...
LaScierie = Place.create!(characteristic: "🚬🍺🖥️", address: "3 allée de l'Ile Gloriette 44000 Nantes", name:"La Scierie", status:"Places disponibles")
...
Brasseurs = Place.create!(characteristic: "🚬🍺🖥️Une cuisine authentique dans l'esprit des anciennes brasseries. De moments généreux et conviviaux à déguster", address: "Centre Commercial Carré 19 Parvis Neptune 44000 Nantes", name:"3 Brasseurs", status:"Places disponibles")
...
LeCascabel = Place.create!(characteristic: "🚬🍺🖥️Une belle cascade de joie vous y attend", address: "1 Rue Kervégan 44000 Nantes", name:"Le Cascabel", status:"Places disponibles")
...
LaBelleEquipe = Place.create!(characteristic: "🚬🍺🖥️L'esprit d'équipe que l'on perde ou que l'on gagne",  address: "10 Quai de la Jonelière 44000 Nantes", name:"La belle equipe", status:"Places disponibles")
...
Giggs = Place.create!(characteristic: "🚬🍺🖥️Un match ne se joue pas que sur la pelouse", address: "4 Pl. Saint-Pierre 44000 Nantes", name:"Gigg's", status:"Places disponibles")
...
brady = Place.create!(characteristic: "🚬🍺🖥️Près du lieu unique, l'ambiance irlandaise à porter de chope", address: "22 Allée Commandant Charcot, 44000 Nantes", name:"Brady's", status:"places disponibles")
...
macbyrne = Place.create!(characteristic: "🚬🍺🖥️Il n'y a pas qu'en irlande qu'on sait savourer un moment de partage autour d'une pinte", address: "21 Rue des Petites Écuries, 44000 Nantes", name:"John McByrne", status:"places disponibles")
...
berlin = Place.create!(characteristic: "🚬🍺🖥️Lieu de rencontre et de partage reconnu Quoi vous ne connaissez pas ? On vous attend pour vous montrer",  address: "95 Boulevard Gabriel Lauriol, 44300 Nantes", name:"Berlin 1989", status:"places disponibles")
...
lab = Place.create!(characteristic: "🚬🍺🖥️En navibus, voiture, vélo, à pieds ou à cheval, tous les chemin mène au LAB", address: "23 Bd de Chantenay, 44100 Nantes", name:"Little Atlantique Brewery", status:"places disponibles")
...
bureau = Place.create!(characteristic: "🚬🍺🖥️Quoi de mieux que de se retrouver au bureau après une journée de travail ?", address: "10 Quai François Mitterrand, 44000 Nantes", name:"Au Bureau", status:"places disponibles")
